...
EXAMPLE_DIRECTORIES = ['socket', 'error-model', 'ipv6', 'traffic-control', 'wireless', 'matrix-topology', 'udp-client-server', 'naming', 'udp', 'routing', 'energy', 'stats', 'tcp', 'tutorial', 'realtime']
