...
EXAMPLE_DIRECTORIES = ['socket', 'error-model', 'ipv6', 'traffic-control', 'wireless', 'matrix-topology', 'udp-client-server', 'naming', 'udp', 'routing', 'energy', 'ns3_test', 'stats', 'tcp', 'tutorial', 'realtime']
...
NS3_EXECUTABLE_PATH = ['/root/Telecommunication/Exper.2/tarballs/ns-allinone-3.28/ns-3.28/build/src/fd-net-device', '/root/Telecommunication/Exper.2/tarballs/ns-allinone-3.28/ns-3.28/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/root/Telecommunication/Exper.2/tarballs/ns-allinone-3.28/ns-3.28/build']
...
VALGRIND_FOUND = True
VERSION = '3.28'
WITH_PYBINDGEN = '/root/Telecommunication/Exper.2/tarballs/ns-allinone-3.28/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/root/Telecommunication/Exper.2/tarballs/ns-allinone-3.28/ns-3.28/build/ns3/config-store-config.h', '/root/Telecommunication/Exper.2/tarballs/ns-allinone-3.28/ns-3.28/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
